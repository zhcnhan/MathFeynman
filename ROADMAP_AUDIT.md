...
- R18 内容不变式：手写边越界 0 / 首领无主/错主 0 / 差异说明 1
  - 说明: middle.0199 组内已落地节点未在其手写 prereq 中: middle.m15、middle.m16、middle.m17、middle.m18、middle.m19（门禁=引擎组达成，手写仅展示）
...
- R18 内容不变式：手写边越界 0 / 首领无主/错主 0 / 差异说明 1
  - 说明: primary.0199 组内已落地节点未在其手写 prereq 中: primary.s01、primary.s02、primary.s03、primary.s04、primary.s09、primary.s10、primary.s22、primary.s23（门禁=引擎组达成，手写仅展示）
...
- 跨学段引用 0（前序学段）/ 反向 0 / 未落地缺口提示 0（提示不阻塞，学段顺序兜底）
- R18 内容不变式：手写边越界 0 / 首领无主/错主 0 / 差异说明 1
  - 说明: high.0201(无所属蓝图条目=孤儿，内容 prereq 仅受学段/内容边约束)
...
- R18 内容不变式：手写边越界 0 / 首领无主/错主 0 / 差异说明 0
